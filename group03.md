...
高春辉老师课程内容丰富，理论与实践结合紧密，教学能力出众，课堂生动有趣，将难懂的编程理论知识讲解的十分清楚，让从没接触过编程的我也能轻易理解相关知识。在高老师的指导下，让我初步了解了R语言和Python的基础知识，并能运用其将数据进行处理以及可视化分析。使用GitHub进行版本控制，在VScode中完成代码开发，并借助大语言模型辅助，成功搭建个人网站。课程采用"理论+项目"教学模式，有效培养了实践能力。但是在学习过程中，对于代码小白、编程零基础的同学来讲，在软件环境配置、代码调试等方面还是有一定的困难，当然在软件下载方面也有一定困难。课程上内容很充实，基本涵盖专业所需内容，但是研究方向的细化，很多课程内容在后续会使用不到，与专业实用性联系不强。总而言之，课程内容很充实，专业性很强。在高老师的教学下，零基础的同学也可以将这么呢课程完成下来，高老师能将理论知识与动手实践充分结合起来，锻炼学生的动手能力。
